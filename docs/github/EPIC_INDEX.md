...
| [17_living_garage_system_issues.md](issues/17_living_garage_system_issues.md) | Living Garage System | Drafts design/documentation issues reframing the garage as the living home hub: living garage system, physical inventory layout, bike display, parts shelves, clutter/capacity, garage upgrades, garage museum, family/social garage interactions, purchased-item arrival flow, garage UI navigation, garage visual states over time, garage persistence, minimum v1.0 garage, and DD-0036 through DD-0038. | Garage Shop System; Bike Ownership System; Mechanics Maintenance Engine; Marketplace; Memory Engine; Documentary Legacy Recap Engine; Family Life Engine; Phone / Internet UI; Career Outcomes System |
| [18_p0_calendar_loretta_marketplace_fixes.md](issues/18_p0_calendar_loretta_marketplace_fixes.md) | P0 Calendar, Loretta, Marketplace & Season-Flow Fixes | Drafts urgent P0 fix issues for parent-controlled marketplace/repairs for young riders, correcting the Loretta's qualification structure (Area → Regional → National), a month-based season calendar, safe mid-season schedule editing, and calendar/season-flow regression tests. | Age & Responsibility Progression; Marketplace Engine; Garage Shop System; Mechanics Maintenance Engine; Road to Loretta's; Calendar & Time Engine; Season Planner; Competition / Race Engine; Release Readiness |
